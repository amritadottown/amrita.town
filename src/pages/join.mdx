 ...
 **is my website a reflection of me?**   
    ...
    it should be _you_ doing all this. we won't accept websites with any amount of ai-generated text. you can use ai to help with development, but it must be _your_ creative vision.
    your website will start small, and this is perfectly fine. it will grow over time along with you and there's no need to bloat it in advance, especially with visual/UI gimmicks that you don't fully believe in. [here's](https://jagudev.net/index.html) an example of a tiny personal website that still says a lot.
...
2. send a pr to add yourself to `src/members.json` on our [github](https://github.com/amritadottown/website).

3. if we find you cool, welcome to amrita.town!  
    
4. if you're accepted, add these links to your website. most people put it in the footer, but presentation is up to you. just make sure it's easily accessible. **avoid doing this preemptively.**
